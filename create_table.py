...
conn.execute('CREATE TABLE registration2 (username VARCHAR(35) NOT NULL PRIMARY KEY, email VARCHAR(35) NOT NULL, password VARCHAR(200) NOT NULL, phone VARCHAR NOT NULL)')
